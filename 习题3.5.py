...
plt.xlabel('密度', fontproperties='Arial Unicode MS', fontsize=15, color='green')
plt.ylabel('含糖率', fontproperties='Arial Unicode MS', fontsize=15, color='green')
plt.title(r'3.5 线性判别分析', fontproperties='Arial Unicode MS', fontsize=25)
plt.legend()
plt.show()
